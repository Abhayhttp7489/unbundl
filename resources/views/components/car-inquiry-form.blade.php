...
<div id="inquiryModal" class="inquiry-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 10000; overflow-y: auto; padding: 20px;">
    <div class="inquiry-modal-content" style="max-width: 800px; margin: 50px auto; background: white; padding: 40px; border-radius: 10px; box-shadow: 0 4px 20px rgba(0,0,0,0.3); position: relative;">
        ...
        <form action="{{ route('car-inquiry.store') }}" method="POST">
            @csrf
            ...
            <div class="inquiry-form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="name" value="{{ old('name') }}" required class="inquiry-form-input" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 5px; font-size: 16px; box-sizing: border-box;">
            </div>
            ...
            <div class="inquiry-form-group" style="margin-bottom: 20px;">
                ...
                <input type="tel" name="phone_number" value="{{ old('phone_number') }}" required class="inquiry-form-input" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 5px; font-size: 16px; box-sizing: border-box;">
            </div>
            ...
            <div class="inquiry-form-group" style="margin-bottom: 20px;">
                ...
                <input type="email" name="email" value="{{ old('email') }}" required class="inquiry-form-input" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 5px; font-size: 16px; box-sizing: border-box;">
            </div>
            ...
            <div class="inquiry-form-group" style="margin-bottom: 20px;">
                ...
                <textarea name="address" rows="3" required class="inquiry-form-textarea" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 5px; font-size: 16px; resize: vertical; box-sizing: border-box;">{{ old('address') }}</textarea>
            </div>
            ...
            <div class="inquiry-form-group" style="margin-bottom: 20px;">
                ...
                <div class="inquiry-checkbox-group" style="display: flex; gap: 20px; flex-wrap: wrap;">
                    <label class="inquiry-checkbox-label" style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                        <input type="checkbox" name="car_types[]" value="Hatchback" {{ in_array('Hatchback', old('car_types', [])) ? 'checked' : '' }} style="width: 18px; height: 18px; cursor: pointer;">
                        <span class="inquiry-checkbox-text" style="font-size: 16px;">Hatchback</span>
                    </label>
                    <label class="inquiry-checkbox-label" style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                        <input type="checkbox" name="car_types[]" value="Sedan" {{ in_array('Sedan', old('car_types', [])) ? 'checked' : '' }} style="width: 18px; height: 18px; cursor: pointer;">
                        <span class="inquiry-checkbox-text" style="font-size: 16px;">Sedan</span>
                    </label>
                    <label class="inquiry-checkbox-label" style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                        <input type="checkbox" name="car_types[]" value="SUV" {{ in_array('SUV', old('car_types', [])) ? 'checked' : '' }} style="width: 18px; height: 18px; cursor: pointer;">
