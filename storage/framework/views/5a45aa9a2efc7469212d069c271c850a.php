                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $latestCarsLimited; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="latest-car-card" style="min-width: 320px; max-width: 320px; background: white; border-radius: 8px; overflow: hidden; border: 1px solid #E0E0E0; flex-shrink: 0;">
                            ...
                            <div class="latest-car-card-content" style="padding: 20px;">
                                <h3 class="latest-car-name" style="font-size: 18px; margin-bottom: 10px; color: #333; font-weight: 600;"><?php echo e($car->name); ?></h3>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($car->min_price && $car->max_price): ?>
                                    <p class="latest-car-price" style="font-size: 16px; font-weight: 600; color: #333; margin-bottom: 15px;">₹<?php echo e(number_format($car->min_price, 2)); ?> - <?php echo e(number_format($car->max_price, 2)); ?> Lakh*</p>
                                <?php elseif($car->price): ?>
                                    <p class="latest-car-price" style="font-size: 16px; font-weight: 600; color: #333; margin-bottom: 15px;">₹<?php echo e(number_format($car->price / 100000, 2)); ?> Lakh*</p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
