    ...
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: center; gap: 40px;">
            ...
            <div style="flex-shrink: 0;">
                <img src="<?php echo e(asset('assest/logo/cardekho-logo-hd.png')); ?>" alt="CarsDekho Logo" style="height: 120px; width: auto; object-fit: contain;">
            </div>
            
            <!-- Search Bar (Center) -->
            <div style="flex: 1; max-width: 450px; margin: 0 auto;">
            ...
            <div style="flex-shrink: 0; display: flex; align-items: center; gap: 30px;">
                <!-- Language Selector -->
                <div style="display: flex; align-items: center; cursor: pointer;" onclick="toggleLanguageDropdown()">
                ...
                <!-- Login / Register -->
                <div style="display: flex; align-items: center; cursor: pointer; gap: 8px;" onclick="window.location.href='#'">
                    ...
                    <span style="color: #333; font-size: 14px;">Login / Register</span>
                </div>
                
                <!-- Admin Button -->
                <a href="/admin" style="background: #e63946; color: white; padding: 8px 20px; border-radius: 5px; text-decoration: none; font-weight: 500; display: inline-block;">Admin</a>
            </div>
        </div>
    </div>
</header>
